<%-- 
    Document   : addmhs
    Created on : Mar 7, 2015, 5:47:40 PM
...
<html>
    ...
    <body>
        ...
        <div align="center" width="500px">
            <form:form method="post" action="${pageContext.request.contextPath}/addmhs" commandName="mahasiswa">
            <h2>Add Data</h2>
            ...
            <table>
                ...
                <tr>
                 ...
                 <tr>
                     <td><form:button type="submit" value="Add Record" name="action">Add Record</form:button></td>
                    <td></td>
                </tr>
            </table>
            </form:form>
